...
namespace DetailTest\Bernard;

use PHPUnit_Framework_TestCase as TestCase;

use Detail\Bernard\Module;
...
class ModuleTest extends TestCase
{
    ...
    public function testModuleProvidesAutoloaderConfig()
    {
        ...
        $this->assertArrayHasKey('Detail\Bernard', $config['Zend\Loader\StandardAutoloader']['namespaces']);
    }
    ...
    public function testModuleProvidesConfig()
    {
        ...
        $this->assertTrue(is_array($config));
        $this->assertArrayHasKey('bernard', $config);
    }
